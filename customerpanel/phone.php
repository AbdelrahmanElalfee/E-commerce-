...
include './shared/carap.php';
$select = "SELECT * FROM `products` WHERE sectionid = 12";
...
<h1 class="text mt-5 ml-5" style="color:  #3C096C;">Products</h1>
  <!-- cards -->
          ...
          <div class="col mb-4" id="col1">
            <div class="card-groups bg-light card border-dark mb-3 ml-4" style="padding:auto; width: 400px; height: 750px;" id="card">
              ...
              <div class="card-body">
                ...
                <a href="/projects/ecommerce/customerpanel/Buy.php?pro=<?php echo $data['id'];?>" id="buy" class="btn btn-block mt-5" style="color: white; background-color: #3C096C">Buy Now</a>
                <a href="/projects/ecommerce/customerpanel/feedback.php?feed=<?php echo $data['id']; ?>" id="feed" class="btn btn-block" style="background-color: #C77DFF; color:white;">Feedback</a>
              </div>
            </div>
          </div>
        </div>
