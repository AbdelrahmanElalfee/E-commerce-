...
include './shared/caraf.php';
include '../shared/config.php' ;
$id = 11;
$select = "SELECT * FROM `products` WHERE sectionid = '$id'";
...
<h1 class="text mt-5 ml-5" style="color: #3C096C;">Fashions</h1>
  <!-- cards -->
        ...
        <div class="row row-cols-1 row-cols-md-3">
          <div class="col mb-4" id="col1">
            <div class="card-groups bg-light card border-dark mb-3 ml-4" style="padding:auto; width: 400px; height: 750px;" id="card">
              <img src="/projects/ecommerce/products/upload/<?php echo $data['photo']; ?>" class="card-img-top mt-4" style="width: 390px; height: 390px" alt="product">
              <div class="card-body">
